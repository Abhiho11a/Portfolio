...
const themes = {
  cyberpunk: {
    ...
    colors: {
      ...
      '--bg-card-strong': 'rgba(24, 24, 27, 0.8)',
      '--border-subtle': 'rgba(63, 63, 70, 0.4)',
      '--border-medium': 'rgba(63, 63, 70, 0.5)',
      '--text-primary': '#fafafa',
  ...
  violet: {
    ...
    colors: {
      ...
      '--bg-primary': '#0B0910',
      '--bg-card': 'rgba(25, 20, 35, 0.6)',
      '--bg-card-strong': 'rgba(25, 20, 35, 0.85)',
      '--border-subtle': 'rgba(107, 70, 193, 0.4)',
      '--border-medium': 'rgba(107, 70, 193, 0.5)',
      '--text-primary': '#faf5ff',
  ...
  ember: {
    ...
    colors: {
      ...
      '--bg-card-strong': 'rgba(28, 25, 23, 0.85)',
      '--border-subtle': 'rgba(68, 64, 60, 0.4)',
      '--border-medium': 'rgba(68, 64, 60, 0.5)',
      '--text-primary': '#fafaf9',
