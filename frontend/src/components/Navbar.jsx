    ...
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 max-w-[95vw]">
      ...
      <AnimatePresence>
        {canScrollLeft && (
          ...
          >
            <ChevronLeft size={16} className="text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500" />
          </motion.div>
        )}
      </AnimatePresence>
