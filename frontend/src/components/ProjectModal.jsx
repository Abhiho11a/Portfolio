                ...
                <div className="pt-6 border-t border-zinc-200/50 dark:border-zinc-800/50 flex flex-wrap gap-8">
                  {Object.entries(project.stats).map(([key, value]) => (
                    <div key={key}>
                      ...
                      <span className="text-sm text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 uppercase tracking-wider font-semibold">{key}</span>
                    </div>
                  ))}
                </div>
              )}
