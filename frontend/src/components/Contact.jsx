          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <button onClick={() => setIsModalOpen(true)} className="w-full group flex items-center gap-3 p-4 rounded-xl bg-zinc-50/40 dark:bg-zinc-900/40 border border-zinc-200/40 dark:border-zinc-800/40 hover:border-[var(--accent)]/30 hover:bg-[var(--accent)]/5 transition-all text-left">
              ...
              <div className="flex-1">
                ...
                <span className="text-xs text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500">Send a direct message</span>
              </div>
            ...
            <a href={contactData.linkedin} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 p-4 rounded-xl bg-zinc-50/40 dark:bg-zinc-900/40 border border-zinc-200/40 dark:border-zinc-800/40 hover:border-[var(--secondary)]/30 hover:bg-[var(--secondary)]/5 transition-all">
              ...
              <div className="text-left">
                ...
                <span className="text-xs text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500">Connect with me</span>
              </div>
              <ArrowUpRight size={14} className="ml-auto text-zinc-600 group-hover:text-[var(--secondary)] transition-colors" />
            </a>
          </div>

          <div className="flex items-center justify-center gap-2 text-sm text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-500">
